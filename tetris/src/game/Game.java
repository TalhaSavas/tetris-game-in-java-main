...
public class Game {
	...
	private static final int NEXT_PIECE_Y = 3;
	...
	// create a private piece called storedPiece that  stores the piece that was stored
	public Piece storedPiece;
	// create a private boolean called stored that stores whether or not a piece has been stored
	...
	private void tick() {
		...
		if (this.field.isPieceFallen(currentPiece)) {
			...
			if (this.field.isPiecePlaceable(currentPiece)) {
	...
	//create a swap method that   stores the currentPiece on the bottom right of the screen. Whenever she/he wants to use this stored piece, she/he presses the key ‘s’ again and the currentPiece and the piece in the store will be swapped.
